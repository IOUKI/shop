...
CREATE TABLE products (
    ...
    created_at DATETIME NOT NULL, -- 商品創建時間
...
CREATE TABLE categories (
    ...
    created_at DATETIME NOT NULL, -- 商品分類創建時間
...
CREATE TABLE orders (
    ...
    created_at DATETIME NOT NULL, -- 訂單創建時間
...
CREATE TABLE order_items (
    ...
    created_at DATETIME NOT NULL, -- 訂單商品創建時間
...
CREATE TABLE users (
    ...
    title VARCHAR(100) NOT NULL, -- 用戶名稱
    email VARCHAR(100) NOT NULL, -- 用戶郵箱
    hash_key VARCHAR(500) NOT NULL, -- 用戶密碼(hash key)
    hash_salt VARCHAR(100) NOT NULL, -- (hash salt)
    created_at DATETIME NOT NULL, -- 用戶創建時間
...
CREATE TABLE admin_user (
    id VARCHAR(100) NOT NULL, -- 管理員 ID (主鍵)
    title VARCHAR(100) NOT NULL, -- 管理員名稱
    account VARCHAR(100) NOT NULL, -- 管理員帳號
    hash_key VARCHAR(500) NOT NULL, -- hash key
    hash_salt VARCHAR(100) NOT NULL, -- hash salt
...
CREATE TABLE addresses (
    ...
    title VARCHAR(100) NOT NULL, -- 收貨人姓名
    phone VARCHAR(100) NOT NULL, -- 收貨人電話
    addr VARCHAR(200) NOT NULL, -- 收貨人地址
    created_at DATETIME NOT NULL, -- 地址創建時間
...
CREATE TABLE stocks (
    ...
    created_at DATETIME NOT NULL, -- 庫存創建時間
    PRIMARY KEY (id)
);
...
CREATE TABLE pageviews (
    ...
    page_url VARCHAR(100) NOT NULL, -- 訪問頁面 URL
...
-- admin account setup
INSERT INTO admin_user(id, title, account, hash_key, hash_salt, created_at)
VALUES('R001', 'admin', 'lan0225', '5fd2b03b712ff1b7e53b5bb896e1acce5c9e10bc220bb142774eaf183f551664', 'E]0-/yO4t2', now())